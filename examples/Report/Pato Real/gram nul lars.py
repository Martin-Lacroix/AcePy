...
plt.savefig("patoRealTStd.pdf",bbox_inches="tight",format="pdf",transparent=True)
...
plt.gca().spines['right'].set_color('none')
plt.gca().spines['top'].set_color('none')
plt.savefig("patoRealMgMean.pdf",bbox_inches="tight",format="pdf",transparent=True)
...
plt.gca().spines['right'].set_color('none')
plt.gca().spines['top'].set_color('none')
plt.savefig("patoRealMgStd.pdf",bbox_inches="tight",format="pdf",transparent=True)
...
plt.gca().spines['right'].set_color('none')
plt.gca().spines['top'].set_color('none')
plt.savefig("patoRealCharVirgMean.pdf",bbox_inches="tight",format="pdf",transparent=True)
...
plt.gca().spines['right'].set_color('none')
plt.gca().spines['top'].set_color('none')
plt.savefig("patoRealCharVirgStd.pdf",bbox_inches="tight",format="pdf",transparent=True)
...
plt.savefig("patoRealTMean.pdf",bbox_inches="tight",format="pdf",transparent=True)